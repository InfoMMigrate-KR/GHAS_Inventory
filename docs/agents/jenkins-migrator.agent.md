...
Use the `github-mcp-server-get_file_contents` tool to retrieve knowledge base documentation:
...
**Fetch the Migration Workflow document from the knowledge base** using `github-mcp-server-get_file_contents` for detailed guidance on the 5-phase process:
...
**Fetch the Jenkins Groovy Patterns guide** (`knowledge/patterns/jenkins/groovy.md`) from the knowledge base for:
...
**Fetch the Jenkins Secrets Guide** (`knowledge/patterns/jenkins/secrets.md`) from the knowledge base for patterns covering:
...
**Fetch Migration Standards** (`knowledge/migration-standards.md`) from the knowledge base for the full 15-item completion checklist.
